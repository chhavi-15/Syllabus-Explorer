...
<div>
    <div class="w3_wthree_agileits_icons.main-grid-border">
        <h4 class="title" style="text-align:center;margin-bottom:40px"><span>S</span>yllabus <span>D</span>etails <span>F</span>or <span>M</span>CA</h4>  
    </div>
</div>

<?php include("Filter_Form_MCA.php");?>
...
<div id="result">
    ...
    <table id="myTable" class="table responsive-utilities"> 
        ...
        $sql = "SELECT * FROM syllabus WHERE Programme = 'MCA'";
        ?>
        <tbody>
        <?php 
            include('config.php');
