...
$semesterQuery = "SELECT DISTINCT Semester FROM syllabus WHERE Programme = 'MCA' ORDER BY Semester ASC";
$semesterResult = mysqli_query($con, $semesterQuery);

// Query to get unique credit systems
$creditSystemQuery = "SELECT DISTINCT Credit_System FROM syllabus WHERE Programme = 'MCA' ORDER BY Credit_System ASC";
$creditSystemResult = mysqli_query($con, $creditSystemQuery);

// Query to get unique years (Year1)
$yearQuery = "SELECT DISTINCT Year1 FROM syllabus WHERE Programme = 'MCA' ORDER BY Year1 ASC";
